...
<section id="cart" class="py-3">
    <div class="container-fluid w-75">
        <h5 class="font-arial font-size-20">Shopping Cart</h5>
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "./static/assets/products/1.png" ?>"
                            style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-arial font-size-20">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-rale w-25">
                                ...
                                <input type="text" data-id="<?php echo $item['item_id'] ?? '0'; ?>"
                                    class="qty_input border px-2 w-100 bg-light" disabled value="1" placeholder="1" max="<?php echo $item['item_quantity'] ?? 0; ?>">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" name="delete-cart-submit"
                                    class="btn font-arial text-danger px-3 border-right">Delete</button>
                            </form>

                            <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="wishlist-submit" class="btn font-arial text-danger">Save for
                                    Later</button>
                            </form>
                        </div>
                        <!-- !product qty -->
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="font-size-20 text-danger font-arial">
                            R<span class="product_price" data-id="<?php echo $item['item_id'] ?? '0'; ?>">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-arial font-size-20">Subtotal (
                            <?php echo isset($subTotal) ? count($subTotal) : 0; ?> item):&nbsp; <span
                                class="text-danger">R<span class="text-danger" id="deal-price">
