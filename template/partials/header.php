...
<body>
  ...
  <header>
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
      <p class="font-arial font-size-12 text-black-50 m-0">6 Beach Rd, Woodstock, Cape Town, 8000(Generic address of a
        business)</p>
      <div class="font-arial font-size-14">
        <a href="#" class="px-3 border-right border-left text-dark">Login</a>
        <a href="cart.php" class="px-3 border-right text-dark">WishList <span class="color-wishlist"><i
